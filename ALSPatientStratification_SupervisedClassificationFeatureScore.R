...
#This script is used to select features for supervised classification using NMF feature scores.
#HiSeq samples are set as the holdout test set
#NovaSeq samples are split into 70% training 30% testing (in Python)
...
#Save workspace 
#wd = 'D:/Jarrett/Research/Fall 2021/'
#setwd(wd)
#save.image("SAKEfeatures2ClassifierMatrix_CP.RData")
#load("D:/Jarrett/Research/Fall 2021/SAKEfeatures2ClassifierMatrix_CP.RData")

wd = 'C:/Users/jeshima/Documents/Smith Lab/Summer 2021/ALS Subtyping/Clustering w 451ALS/AllSubjects2/'
setwd(wd)
##Correct feature set for excel auto-format driven errors (MARCH3 --> 3-Mar)
myfeaturesets = "Otop1000ALL"
...
table(rownames(OA1000H) == rownames(OA1000N))



#Manually save each feature set 
setwd("C:/Users/jeshima/Documents/Smith Lab/Summer 2021/ALS Subtyping/Supervised Classification/Holdout")

filen2 = "Hi_Supervised_Classifier_OverlappingPlatform_All_1000.csv"
write.csv(OA1000H,filen2) 
filen2 = "Nova_Supervised_Classifier_OverlappingPlatform_All_1000.csv"
write.csv(OA1000N,filen2) 
