...
#This script is designed to assess whether TE expression is tightly correlated at the subfamily, family, and/or superfamily levels (in our ALS cohort).
...
ClassMat = read.csv("Table_S5.csv") #Generated in previous script
