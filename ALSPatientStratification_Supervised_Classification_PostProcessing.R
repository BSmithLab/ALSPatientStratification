...
setwd("D:/Jarrett/Research/Summer 2021/FinalClassificationResults_12-13-21/EigenGene/ALSresults/")
d = "D:/Jarrett/Research/Summer 2021/FinalClassificationResults_12-13-21/EigenGene/ALSresults/"
...
par(mfrow=c(1,3))
modelnames = "ALS" #same order as myfolders
...
for(i in 1:length(myfolders)){
  ...
  p = p+ theme(plot.margin = unit(c(1,1,1,1), "cm"))
  p = p+theme(plot.title = element_text(hjust = 0.5))
  p = p+theme(axis.text = element_text(size=20), axis.title = element_text(size=20),plot.title = element_text(size=20),legend.text = element_text(size=16),legend.title = element_text(size=16))
  print(p)
