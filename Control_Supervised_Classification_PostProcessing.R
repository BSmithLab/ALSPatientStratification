...
setwd("D:/Jarrett/Research/Summer 2021/FinalClassificationResults_12-13-21/EigenGene/results/")
d = "D:/Jarrett/Research/Summer 2021/FinalClassificationResults_12-13-21/EigenGene/results/"
...
for(i in 1:length(myfolders)){
  for(j in 1:length(models)){
    ...
    axis(at=1:4,side=1,labels=c("ALS-TE","ALS-Ox","ALS-Glia","Control"),cex.axis=1.25)
...
for(i in 1:length(myfolders)){
  ...
  Subtype = rep(c("Control","Glia","OX","TE"),100)
