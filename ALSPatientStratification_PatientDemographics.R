...
boxplot(TEaoo,OXaoo,GLaoo,DIaoo,xaxt="n",main=c("Subtype Age of Onset"),cex.axis = 1.5,cex.main=1.5,col=c("firebrick","navy","goldenrod1","darkorchid2"),xlab="Subtype",ylab="Age of Onset (years)",cex.lab=1.5)
axis(at=1:4,side=1,labels=c("TE","OX","Glia","Discordant"),cex.axis=1.25)
...
boxplot(TEaod,OXaod,GLaod,DIaod,xaxt="n",main=c("Subtype Age of Death"),cex.axis = 1.5,cex.main=1.5,col=c("firebrick","navy","goldenrod1","darkorchid2"),xlab="Subtype",ylab="Age of Death",cex.lab=1.5)
axis(at=1:4,side=1,labels=c("TE","OX","Glia","Discordant"),cex.axis=1.25)
...
vd = c(visdata.t,visdata.o,visdata.g,visdata.d)

barplot(vd,main="ALS Subtype FTD Comorbidity",names.arg = c("TE","Ox","GLIA","Discordant"),cex.axis = 1.25,cex.names = 1.25,cex.lab=1.5,xlab="Subtype",ylab="FTD Comorbidity (%)",col=c("firebrick","navy","goldenrod1","darkorchid2"),ylim = c(0,0.25))
