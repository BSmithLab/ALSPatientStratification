...
clf = load('SVM_OA1000_Calibrated_Trainweights_100k.joblib')
...
DF2 = pd.concat(DF)
DF2.to_csv('pydat/results/SVM/HiSeqHoldout_SVM_results_OA1000_Calibrated_Trainweights_100k.csv')
...
fig.savefig('pydat/ROC/HiSeq_Holdout_ROC_SVM_OA1000_Calibrated_Trainweights_100k.svg')