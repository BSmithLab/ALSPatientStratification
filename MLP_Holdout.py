...
clf = load('MLP_OA1000_adam_tanh.joblib')
...
DF2 = pd.concat(DF)
DF2.to_csv('pydat/results/MLP/HiSeqHoldout_MLP_results_3layer100Units_OA1000_adam_tanh.csv')
...
fig.savefig('pydat/ROC/HiSeq_Holdout_ROC_MLP_OA1000_adam_tanh.svg')
