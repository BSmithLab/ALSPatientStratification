...
clf = load('RF_OA1000_ntree1000_TrainWeights.joblib')
...
DF2 = pd.concat(DF)
DF2.to_csv('pydat/results/RFpy/HiSeqHoldout_RF_results_ntree1000_OA1000_TrainWeights.csv')
...
fig.savefig('pydat/ROC/HiSeq_Holdout_ROC_RF_ntree1000_OA1000_TrainWeights.svg')