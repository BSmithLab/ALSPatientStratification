...
#Run twice for NovaSeq cohort (train/test) and HiSeq cohort (holdout)

#Generate Loom File
setwd("C:/Users/jeshima/Documents/Smith Lab/Summer 2021/ALS Subtyping/Supervised Classification/Holdout")
ExpData = read.csv("Nova_Supervised_Classifier_OverlappingPlatform_All_1000.csv") #File generated in previous script
rownames(ExpData) = ExpData[,1]
ExpData = ExpData[,-1]

#setwd("C:/Users/jeshima/Documents/Smith Lab/Summer 2021/ALS Subtyping/Supervised Classification")
loomR::create("Nova_OA1000.loom",ExpData)

#Read in Pheno Data and other relevant files
Pheno = read.csv("Nova_ALS_coldata_SUBTYPES.csv") #File generated in previous script
colnames(Pheno)[1] = "ID"
...
lfile = connect(filename = "Nova_OA1000.loom",mode = "r+")

#Convert Pheno Data to Loom file
nsub=nrow(Pheno) #Only the ALS cohort
