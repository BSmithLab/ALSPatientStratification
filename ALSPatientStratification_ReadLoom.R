...
ExpData = read.csv("Supervised_Classifier_CombinedPlatform_1000.csv") #File generated in previous script
rownames(ExpData) = ExpData[,1]
ExpData = ExpData[,-1]

#setwd("C:/Users/jeshima/Documents/Smith Lab/Summer 2021/ALS Subtyping/Supervised Classification")
loomR::create("ALS451_CA1000.loom",ExpData)

#Read in Pheno Data and other relevant files
Pheno = read.csv("ALS451_coldata_SUBTYPES.csv") #File generated in previous script
colnames(Pheno)[1] = "ID"
...
lfile = connect(filename = "ALS451_CA1000.loom",mode = "r+")

#Convert Pheno Data to Loom file
nsub=451 #Only the ALS cohort
